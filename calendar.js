...
document.getElementById('next').addEventListener('click', removeDays, false);
document.getElementById('prev').addEventListener('click', removeDays, false);
document.getElementById('prev').addEventListener('click', prevMonth, false);
document.getElementById('today').addEventListener('click', removeDays, false);
